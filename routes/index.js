...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Ornament App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Ornament App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Ornament App Login', user : req.user }); 
}); 
